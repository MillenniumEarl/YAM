...
export default class Paths {
   ...
   */
  public WINDOWS_SCRIPTS_PATH = () => join(this.#APP_PATH, "dist", "renderer", "windows");

  /**
   * Path to the directory that contains all the window's HTML scripts.
   */
  public WINDOWS_HTML_PATH = () => join(this.#ASSETS_PATH, "windows");

  /**
   * Path to this application's icon (`ico` file).
   */
  public APP_ICON = () => join(this.#APP_PATH, "resources", "images", "icon.ico");
}
